        ...
        <div class="page d-flex flex-row flex-column-fluid">
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
                    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap" style="padding: 35px;
                    margin-top: -20px; margin-bottom:-60px">
                        <div class="page-title d-flex flex-column me-3">
                            <h1 class="d-flex text-white fw-bold my-1 fs-3">Hello Admin</h1>
                                ...
                                <div class="header-menu align-items-stretch">
                                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0"
                                        ...
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'click'}"
                                            ...
                                            <span class="menu-link py-3">
                                                <span class="menu-title fw-bold" style="color:white;">Create Teachers</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </span>
                                        </div>
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'click'}"
                                            ...
                                            <span class="menu-link py-3">
                                                <span class="menu-title fw-bold" style="color:white;">Create Parents</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </span>
                                        </div>
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'click'}"
                                            ...
                                            <span class="menu-link py-3">
                                                <span class="menu-title fw-bold" style="color:white;">Create Grades</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </span>
                                        </div>
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'click'}"
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bold d-flex align-items-center fs-5">Noorul
                                                    </div>
                                                    <a href="#"
                                                        class="fw-semibold text-muted text-hover-primary fs-7">nicemoor786@gmail.com</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="menu-item px-5">
                                            <a href="signup.php" class="menu-link px-5">Sign Out</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="m-0">
                                            <h1 class="fw-semibold text-white text-center lh-lg mb-9">
                                                <span class="animate__animated animate__fadeInDown animate__slow animate__infinite">
                                                    Welcome to the Smart School Portal!
                                                </span>
                                                <br>
                                                <span class="fw-bolder d-block animate__animated animate__fadeInLeft animate__slower animate__delay-2s animate__infinite">
                                                    Empowering Attendance, Inspiring Excellence
                                                </span>
                                            </h1>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="me-2">
                                                                    ...
                                                                    <span
                                                                        class="text-gray-400 fw-bold d-block fs-7">Great,
                                                                        you always attending class. keep it up</span>
                                                                </div>
                                                                <!--end::Section-->
                                                            </div>
                                                            <!--end::Block-->
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="me-2">
                                                                    ...
                                                                    <span
                                                                        class="text-gray-400 fw-bold d-block fs-7">Don’t
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="me-2">
                                                                    ...
                                                                    <span class="text-gray-400 fw-bold d-block fs-7">You
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="mx-auto">
                                                            ...
                                                            <div class="d-flex align-items-center mb-2">
                                                                ...
                                                                <!--end::Bullet-->
                                                                <!--begin::Label-->
                                                                <div class="fs-8 fw-semibold text-muted">Precent(133)
                                                                </div>
                                                                <!--end::Label-->
                                                            </div>
                                                            <!--end::Label-->
                                                            ...
                                                            <div class="d-flex align-items-center mb-2">
                                                                ...
                                                                <!--end::Bullet-->
                                                                <!--begin::Label-->
                                                                <div class="fs-8 fw-semibold text-muted">Illness(9)
                                                                </div>
                                                                <!--end::Label-->
                                                            </div>
                                                            <!--end::Label-->
                                ...
                                <div id="kt_sliders_widget_3_slider" class="card card-flush carousel slide h-xl-100"
                                    ...
                                    <div class="card-header pt-5 mb-5">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <span class="text-gray-400 mt-1 fw-semibold fs-7">Avg. 72% completed
                                                lessons</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span
                                                                        class="text-gray-400 fw-bold fs-7 d-block">Physics</span>
                                                                </td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span
                                                                        class="text-gray-400 fw-bold fs-7 d-block">History</span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <span data-kt-element="status"
                                                                        class="badge badge-light-primary">In
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="#"
                                                                        ...
                                                                        380-515</a>
                                                                    <span
                                                                        class="text-gray-400 fw-bold fs-7 d-block">English
                                                                        Language</span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <span data-kt-element="status"
